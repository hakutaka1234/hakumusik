...
from HakuRobotXMusic.utils.database import get_authuser_names, get_cmode
from HakuRobotXMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from HakuRobotXMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Haku.stop_stream(message.chat.id)
    except:
        pass
